import os
print("\033[1;92m [[[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]]] AKASH CYBER (ROBOT) SYSTEM INSTALL. . . . \033[1;30m")
os.system("pkg install espeak")
print("\033[1;92m   [[[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]]] ROBOT INSTALL COMPLETE \033[1;30m")
os.system('espeak -a 300 "Robot install complete"')
print("\033[1;92m   [[[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]]] UPDATE CHECKING BOSS AKASH CYBER KING AKASH\033[1;30m")
os.system("git pull")
...
\033[1;32m █████   ██      ██    ██    █████   
\033[1;32m ██      ██      ██    ██    ██      
\033[1;32m ███████ ███████ ██    ██    ███████ \033[1;35mAKASH DAS\033[1;37m
\033[1;94m[+]=====================================================[+]
[+]CREATED BY   :  AKASH DAS                   
[+]ON GITHUB    :  Akashmitali                      
[+]TOOL VERSION :  0.1                             
[+]NETWORK      :  4G,5G && Wifi                          
[+]TOOL STATUS  :  FREE                            
[+]TOOL'S NAME  :  SMS BOMBING                    
[+]COUNTRY      :  BANGLADESH                      
\033[1;94m[+]=====================================================[+]
...
while amount>ses:
  ...
  if sent1.status_code==200:
    ses+=1
    print(f"\n{ses}  \033[38;5;46m🦋⃟𝐀𝐊𝐀𝐒𝐇✮⃝  𝐃𝐀𝐒𝄟⃝💥  SMS WAS SENT🐼")
  else:
    pass
